    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            #### 수정
            # print("[DEBUG] model_kwargs keys:", list(model_kwargs.keys()))
            # print("[DEBUG] teacher_student in model_kwargs:", "teacher_student" in model_kwargs)
            # print("[DEBUG] model_kwargs.get('teacher_student'):", model_kwargs.get("teacher_student", "❌ NOT FOUND"))
            ...
            logits_warper_student = model_kwargs.get("logits_warper_student", LogitsProcessorList()) #### 수정
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if False and model_kwargs['teacher_student']:
                ...
                if first_marker:
                    print('should only appear once...beam')
                    first_marker = False 
                    next_token_scores_keep = next_token_scores 
                # old version. 
                if self.config.is_encoder_decoder:
    ...
    def beam_search_contra(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if first_marker:
                print('should only appear once...contra ')
                first_marker = False 
                next_token_scores_keep = next_token_scores 
            # old version. 
            # print('beam version.')
