    ...
    for i in range(max_new_tokens):
        ...
        with torch.no_grad():
            ...
            if prob_list:
                ...
                #     compare_pmi = torch.log((_topk_prob+1e-8)/(_window_prob+1e-8))
                #     compare_pmi_sum = compare_pmi.sum(dim=-1).item() # 실수
...
def main():
    ...
    prompt='''A powerful earthquake struck off the coast of Japan early Tuesday morning, triggering tsunami warnings along the eastern seaboard.'''
